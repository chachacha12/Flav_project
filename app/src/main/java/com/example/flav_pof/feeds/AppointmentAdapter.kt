...
import com.example.flav_pof.profileInfo.OnFriendsAddListener
...
class AppointmentAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        val cardView = LayoutInflater.from(parent.context)
            .inflate(com.example.flav_pof.R.layout.item_appointment_list, parent, false) as CardView
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        val appointment_textView = cardView.findViewById<TextView>(com.example.flav_pof.R.id.appointment_textView)
