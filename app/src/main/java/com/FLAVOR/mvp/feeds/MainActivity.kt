...
import com.FLAVOR.mvp.googlemap.mapFragment
import com.FLAVOR.mvp.profileInfo.UserListFragment
...
class MainActivity : BasicActivity(), home_map_Listener, OnAppointment_noexistListener {
    ...
    fun init() {
        ...
        val bottomNavigationView = findViewById<BottomNavigationView>(com.FLAVOR.mvp.R.id.bottomNavigationView)
        bottomNavigationView.setOnNavigationItemSelectedListener {
            when(it.itemId) {
                ...
                R.id.userList -> {
                    ...
                    supportFragmentManager.beginTransaction()
                        .replace(com.FLAVOR.mvp.R.id.container, userListFragment!!)
                        .commit()
                    true
                }
                else ->
